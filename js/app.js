...
formulario.addEventListener('submit', async (e) => {
    ...
    const respuesta = await fetch('https://sheetdb.io/api/v1/y613mmb67cdiy', {
        ...
        body: JSON.stringify({
            ...
            "GAML_AP": formulario.GAML_AP.value,
            "GAML_AI": formulario.GAML_AI.value,
            "GAML_L": formulario.GAML_L.value,
            ...
            "CNI_C": formulario.CNI_C.value,
            "CNI_S": formulario.CNI_S.value,
            "CNI_MP": formulario.CNI_MP.value,
            "CNI_W": formulario.CNI_W.value,
            ...
            "RPCM_C": formulario.RPCM_C.value,
            "RPCM_S": formulario.RPCM_S.value,
            "RPCM_MP": formulario.RPCM_MP.value,
            "RPCM_W": formulario.RPCM_W.value,
            ...
            "AMJA_F": formulario.AMJA_F.value,
            "AMJA_L": formulario.AMJA_L.value,
